...
impl TechRegistry {
    ...
    fn register_default_techs(&mut self) {
        // Tier 1
        self.register(
            Tech::new(TechId::MiningEfficiency1, "Mining Efficiency I", 1, 100)
                .with_cost(ResourceType::Power, 100)
                .with_effect(TechEffect::MiningEfficiency(0.1)),
        );

        self.register(
            Tech::new(TechId::CarryCapacity1, "Carry Capacity I", 1, 100)
                .with_cost(ResourceType::Power, 100)
                .with_effect(TechEffect::CarryCapacity(0.1)),
        );

        self.register(
            Tech::new(TechId::MovementSpeed1, "Movement Speed I", 1, 100)
                .with_cost(ResourceType::Power, 100)
                .with_effect(TechEffect::MovementSpeed(0.1)),
        );

        self.register(
            Tech::new(TechId::ConstructionSpeed1, "Construction Speed I", 1, 100)
                .with_cost(ResourceType::Power, 100)
        ...
        // Tier 2
        self.register(
            Tech::new(TechId::MiningEfficiency2, "Mining Efficiency II", 2, 200)
        ...
        self.register(
            Tech::new(TechId::CarryCapacity2, "Carry Capacity II", 2, 200)
                .with_cost(ResourceType::Power, 200)
                .with_cost(ResourceType::Iron, 50)
        ...
        self.register(
            Tech::new(TechId::MovementSpeed2, "Movement Speed II", 2, 200)
                .with_cost(ResourceType::Power, 200)
                .with_cost(ResourceType::Iron, 50)
        ...
        self.register(
            Tech::new(TechId::CombatDamage1, "Combat Damage I", 2, 200)
                .with_cost(ResourceType::Power, 200)
        ...
        self.register(
            Tech::new(TechId::TowerRange1, "Tower Range I", 2, 200)
                .with_cost(ResourceType::Power, 200)
                .with_cost(ResourceType::Iron, 100)
        ...
        // Tier 3
        self.register(
            Tech::new(TechId::MiningEfficiency3, "Mining Efficiency III", 3, 400)
        ...
        self.register(
            Tech::new(TechId::CarryCapacity3, "Carry Capacity III", 3, 400)
                .with_cost(ResourceType::Power, 400)
                .with_cost(ResourceType::Iron, 100)
                .with_cost(ResourceType::Copper, 50)
        ...
        self.register(
            Tech::new(TechId::CombatDamage2, "Combat Damage II", 3, 400)
                .with_cost(ResourceType::Power, 400)
        ...
        self.register(
            Tech::new(TechId::TowerRange2, "Tower Range II", 3, 400)
                .with_cost(ResourceType::Power, 400)
                .with_cost(ResourceType::Iron, 200)
                .with_cost(ResourceType::Copper, 100)
        ...
        self.register(
            Tech::new(TechId::SpawnSpeed1, "Spawn Speed I", 3, 400)
                .with_cost(ResourceType::Power, 400)
                .with_cost(ResourceType::Iron, 100)
                .with_cost(ResourceType::Copper, 100)
        ...
        // Tier 4
        self.register(
            Tech::new(TechId::SuperMining, "Super Mining", 4, 800)
        ...
        self.register(
            Tech::new(TechId::SuperCarry, "Super Carry", 4, 800)
                .with_cost(ResourceType::Power, 800)
                .with_cost(ResourceType::Iron, 200)
                .with_cost(ResourceType::Copper, 100)
                .with_cost(ResourceType::Silicon, 50)
        ...
        self.register(
            Tech::new(TechId::SuperCombat, "Super Combat", 4, 800)
                .with_cost(ResourceType::Power, 800)
        ...
        self.register(
            Tech::new(TechId::SuperTower, "Super Tower", 4, 800)
                .with_cost(ResourceType::Power, 800)
                .with_cost(ResourceType::Iron, 300)
                .with_cost(ResourceType::Copper, 200)
                .with_cost(ResourceType::Silicon, 100)
